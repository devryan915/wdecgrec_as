...
public class HttpAsyncTaskUtil extends
    ...
    /**
     * @param <T>
     * @param type      HttpAsyncTask.POST HttpAsyncTask.GET HttpAsyncTask.DELETE
     * @param url       请求url
     * @param reqParams 如果是post方法需要将参数传递过来
     * @param callBack  回调方法用来处理返回结果
     * @param objects   数组参数，预留参数非必须参数。
     *                  <p>
