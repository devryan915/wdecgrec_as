...
import thoth.holter.ecg_010.adapter.DialogBleDevInfoAdapter;
import thoth.holter.ecg_010.adapter.DialogOffDataAdapter;
	...
	private void showOffData(List<BleDevInfo> devs) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				DialogOffDataAdapter.ViewHolder holder = (thoth.holter.ecg_010.adapter.DialogOffDataAdapter.ViewHolder) view
						.getTag();
