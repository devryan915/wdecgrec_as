...
import thoth.holter.ecg_010.adapter.DialogSkinListAdapter;
	...
	private void showChangeSkin() {
		...
		listViewChangeSkin.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				DialogSkinListAdapter.ViewHolder holder = (thoth.holter.ecg_010.adapter.DialogSkinListAdapter.ViewHolder) view
						.getTag();
